...
import bgImg from '../assets/images/Futuristic data center corridor.png';
        ...
        <div className="relative z-10 max-w-3xl w-full">
          ...
          <div className="w-full my-8" data-aos="fade-up" data-aos-duration="1800">
            <div className="flex items-center gap-3 bg-white rounded-xl p-2 max-w-md mx-auto shadow-lg">
              ...
              />
              <Link to="/contact">
                <button className="bg-navy-main text-white px-8 py-3 rounded-lg hover:bg-blue-primary transition-all font-bold hidden lg:block">
                  Get Started
                </button>
