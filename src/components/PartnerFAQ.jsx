...
function PartnerFAQ() {
  ...
  return (
    <div
      className="lg:mt-9 h-full flex flex-col lg:flex-row gap-6 px-4 sm:px-6 md:px-0 relative z-40 py-10 lg:py-20 w-full"
      data-aos="fade-up"
        ...
        <div className="space-y-4">
          {companyfaq.map((item, index) => (
            <div key={index} className="rounded-lg p-4 ">
              <button
                className="w-full text-left text-base font-semibold flex justify-between items-center text-[#94949e] hover:text-white"
