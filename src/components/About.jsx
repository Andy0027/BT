          ...
          <div className="w-full lg:w-1/2">
            <div className="flex flex-col gap-4">
              {services.map((item) => (
                ...
                >
                  <div className="w-12 h-12 p-2.5 rounded-full bg-white flex items-center justify-center shadow-[0_0_15px_rgba(46,94,153,0.3)]">
                    {item.id === 1 && (
                      <svg className="w-full h-full text-[#2E5E99]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
