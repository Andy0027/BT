...
function PrivacyPolicy() {
  return (
    <>
      <div className="min-h-screen bg-navy-main bg-scroll lg:py-12 px-10  text-white  ">
        ...
        <div>
          ...
          <div className="lg:w-full  flex flex-col relative z-40 pt-20 lg:pt-28 lg:px-48">
        ...
        <div className="lg:w-full flex lg:px-48 py-12 flex-col relative z-40">
