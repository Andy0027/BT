...
import dashboardVisual from "../assets/images/dashboard visual.png";
import ArchitectureLayers from "../components/ArchitectureLayers";
import OperatingPartner from "../components/OperatingPartner";
...
function Home() {
  ...
  return (
    <main>
      <section className="bg-navy-main relative min-h-[700px] lg:h-screen overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 pt-32 pb-10">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.3fr] gap-16 items-center text-left">
            ...
            >
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-medium text-white tracking-tight leading-[1.1] mb-6">
                Power Your <br />
                <span className="text-blue-400">Infrastructure</span> <br />
                with Next-Gen Cloud
              </h1>
              <motion.p 
                initial={{ opacity: 0 }} 
              ...
              >
                <Link to="contact" className="w-full sm:w-auto">
                  <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="group relative w-full sm:w-auto px-10 py-4 bg-blue-600 text-white font-bold rounded-full overflow-hidden transition-all duration-300 hover:shadow-[0_0_40px_rgba(37,99,235,0.4)]">
                ...
                <Link to="solutions" className="w-full sm:w-auto">
                  <motion.button whileHover={{ scale: 1.02, backgroundColor: "rgba(255,255,255,0.05)" }} whileTap={{ scale: 0.98 }} className="w-full sm:w-auto px-10 py-4 text-white font-bold rounded-full border border-white/10 bg-white/5 backdrop-blur-md hover:border-white/20 transition-all duration-300 group">
              ...
              <motion.div 
                ...
                className="mt-10 flex flex-wrap gap-8 md:gap-16 border-t border-white/5 pt-8 w-full"
              >
                <div className="flex flex-col">
                  <span className="text-2xl md:text-3xl font-bold text-white">99.9%</span>
                  <span className="text-slate-500 text-[10px] uppercase tracking-widest font-bold">Uptime SLA</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-2xl md:text-3xl font-bold text-white">24/7</span>
                  <span className="text-slate-500 text-[10px] uppercase tracking-widest font-bold">Expert Support</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-2xl md:text-3xl font-bold text-white">500+</span>
                  <span className="text-slate-500 text-[10px] uppercase tracking-widest font-bold">Global Deployments</span>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              {/* Main Glow Backdrop */}
              <div className="absolute -inset-10 bg-blue-500/10 blur-[80px] rounded-full pointer-events-none group-hover:bg-blue-400/20 transition-all duration-700" />
              
              <div className="relative transform-gpu transition-all duration-700 hover:rotate-y-[-10deg] hover:rotate-x-[5deg] hover:scale-[1.02]">
                {/* 3D Border & Glow Wrapper */}
                <div className="relative rounded-2xl overflow-hidden border border-blue-400/20 shadow-[0_0_30px_rgba(59,130,246,0.2)] bg-[#030b1a]">
                   <img 
                    src={dashboardVisual} 
                ...
                <div className="absolute -top-6 -left-6 w-32 h-32 bg-indigo-600/20 blur-3xl rounded-full" />
              </div>
            </motion.div>
          </div>
      ...
      {/* Dark Theme Background Wrapper for the rest of the page */}
      <div className="bg-[#020817] relative overflow-hidden">
        <ArchitectureLayers />
        {/* Global Glow Effects */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-600/10 rounded-full blur-[120px] pointer-events-none" />
        <div className="absolute bottom-1/4 left-0 w-[500px] h-[500px] bg-indigo-600/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <section className="relative overflow-hidden py-12 md:py-16 px-4 sm:px-8 md:px-16 bg-transparent">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center mb-10 px-4">
            ...
            <h1 className="font-medium text-3xl sm:text-5xl text-white mb-6">
              Your Digital Presence & <span className="text-blue-400">Infrastructure</span> Is Your Asset
            </h1>
            <p className="text-slate-400 text-lg max-w-xl mx-auto">Scalable, Secure, and High-Performance IaaS Solutions.</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-5 space-y-4">
              {services.map((item, idx) => (
                <div key={idx} onClick={() => setActiveIndex(idx)} className={`group cursor-pointer relative p-6 rounded-2xl border transition-all duration-500 ${activeIndex === idx ? "bg-white/5 border-blue-400/20 shadow-2xl shadow-blue-500/10" : "border-transparent hover:bg-white/5"}`}>
                  <div className="flex items-start gap-4">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-500 ${activeIndex === idx ? "bg-blue-primary text-white scale-110 shadow-lg shadow-blue-500/40" : "bg-white/5 text-slate-300"}`}>{item.icon}</div>
                    <div className="flex-1 min-w-0">
                      <h3 className={`text-xl font-bold transition-colors duration-500 ${activeIndex === idx ? "text-white" : "text-white/40"}`}>{item.title}</h3>
                      <motion.div 
                        initial={false}
                        animate={{ 
                      ...
                      >
                        <p className="text-slate-400 text-base leading-relaxed pr-4 pt-1 mb-1">{item.para}</p>
                      </motion.div>
                    </div>
                  </div>
                  <div className="absolute bottom-0 left-6 right-6 h-px bg-white/5 rounded-full overflow-hidden">
                    {activeIndex === idx && (
            ...
            <div className="lg:col-span-7 relative h-[300px] sm:h-[350px]">
              <AnimatePresence mode="wait">
                <motion.div key={activeIndex} initial={{ opacity: 0, scale: 0.95, x: 20 }} animate={{ opacity: 1, scale: 1, x: 0 }} exit={{ opacity: 0, scale: 1.05, x: -20 }} transition={{ duration: 0.8 }} className="absolute inset-0">
                  <div className="relative h-full rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl shadow-black/50 group">
                    ...
                    <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }} className="absolute bottom-6 left-6 p-4 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-lg">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-blue-primary/20 flex items-center justify-center text-blue-400">{services[activeIndex].icon}</div>
                        <div>
                          <p className="text-[9px] text-white/50 font-bold uppercase tracking-[0.2em]">Status</p>
                          <p className="text-white font-bold text-sm">Peak Efficiency</p>
                        </div>
                      </div>
                    </motion.div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center overflow-hidden">
            ...
            <div className="w-full">
              <Marquee gradient={true} gradientColor={[2, 8, 23]} gradientWidth={100} speed={40}>
          ...
          <div className="text-center mb-16 max-w-7xl mx-auto px-6">
            <div className="flex flex-col items-center">
              <motion.h2 
                ...
                viewport={{ once: true }}
                className="text-white text-2xl sm:text-4xl lg:text-5xl font-bold mb-6 whitespace-nowrap"
              >
                Advanced Infrastructure Built for the <span className="text-blue-400">Infinite Cloud</span>
              </motion.h2>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-32 min-h-[500px]">
             ...
             <div className="w-full lg:w-5/12 relative h-[400px] perspective-1000">
                 <AnimatePresence mode="wait">
                  ...
                  >
                    <div 
                      className={`h-full p-10 rounded-[2.5rem] border shadow-2xl flex flex-col justify-center transition-all duration-700 bg-white/[0.15] border-white/30 backdrop-blur-2xl shadow-blue-500/10`}
                    >
                      <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-8 shadow-lg`} style={{ backgroundColor: `${capabilities[activeCapIndex].accent}20`, color: capabilities[activeCapIndex].accent }}>
                         <motion.div layoutId="accent-blob" className="absolute w-20 h-20 bg-blue-primary/10 rounded-full blur-2xl" />
                         <div className="relative z-10 text-2xl">
                           {activeCapIndex === 0 && <MdCloudQueue />}
                           {activeCapIndex === 1 && <MdNetworkCheck />}
                           {activeCapIndex === 2 && <MdStorage />}
                           {activeCapIndex === 3 && <MdStorage />} 
                         </div>
                      </div>
                      <h3 className="text-3xl font-bold text-white mb-6">
                        {capabilities[activeCapIndex].title} <span style={{ color: capabilities[activeCapIndex].accent }}>{capabilities[activeCapIndex].spanTitle}</span>
                      </h3>
                      <p className="text-slate-400 text-lg leading-relaxed">
                        {capabilities[activeCapIndex].para}
                      </p>
                      ...
                      <div className="mt-10 h-1 bg-white/10 rounded-full overflow-hidden">
                        <motion.div 
                          ...
                          className="h-full"
                          style={{ backgroundColor: capabilities[activeCapIndex].accent }}
                        />
                      </div>
                    </div>
                  </motion.div>
             ...
             <div className="w-full lg:w-6/12 relative h-[450px]">
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    className="absolute inset-0"
                  >
                    <div className="relative w-full h-full rounded-[3rem] overflow-hidden shadow-2xl border bg-white/[0.15] border-white/30 backdrop-blur-2xl shadow-blue-500/10 flex items-center justify-center p-8">
                      <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 via-transparent to-transparent opacity-40" />
                      ...
                      >
                         <div className="w-full h-full flex items-center justify-center">
                           {capabilities[activeCapIndex].chart}
                         </div>
                      </motion.div>
                    </div>
                  </motion.div>
