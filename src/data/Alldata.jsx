...
import googleCloud from "../assets/images/google.svg";
import mongodb from "../assets/images/mongodb.svg";
import node from '../assets/images/node-js.svg';
import docker from '../assets/images/docker.svg'; // Ensure this exists
import worldwide from '../assets/images/worldwide.svg'; // Add a relevant SEO image
...
export let cloudfaq = [
   ...
   export let softwarefaq = [
    ...
    paragraph: "We offer custom software development, web and mobile app development, enterprise software solutions, SaaS product development, and AI-integrated systems.",
    },
    {
    heading: "How do you determine the cost of a software development project?",
    paragraph: "Costs are based on project complexity, features required, technology stack, development hours, and timeline. We provide detailed quotes after understanding your requirements.",
    },
    {
    heading: "How long does it take to develop software?",
    paragraph: "Timelines vary based on project scope—basic apps may take a few weeks, while enterprise solutions can take several months. We offer milestone-based delivery for better tracking.",
    },
    {
    heading: "Do you provide post-launch support and maintenance?",
    paragraph: "Absolutely. We offer flexible maintenance and support packages including bug fixes, updates, feature enhancements, and performance monitoring.",
    }
   ];
   ...
   export let testimonial=[
    ...
    {
        name:"Sophia Patel",
        para:"Switching to Brilliant Technologies' cloud infrastructure was a game-changer for our platform. We now handle spikes in traffic with zero downtime, allowing us to focus on growing our core business and scaling globally.",
        image:testimonial4
    },
    {
        name:"Vikram Jain",
        para:"The performance boost we saw after migrating to their managed servers was immediate. Our page load times dropped significantly, and system latency is at an all-time low. Their technical expertise is truly top-notch.",
        image:testimonial2

    },
    {
        name:"Jessica Martin",
        para:"We've seen significant cost savings since optimizing our resources with Brilliant Technologies. Their transparent pricing and efficient deployment strategies have cut our infrastructure overhead by 30% without sacrificing speed.",
        image:testimonial3
    },
    {
        name:"Rajiv Desai",
        para:"Their DevOps support is exceptional. We've automated our entire CI/CD pipeline, reducing deployment errors by 80%. They are more than a provider; they are a true extension of our engineering team.",
        image:testimonial1
    },
    {
        name:"Samantha Hall",
        para:"The transition to a multi-region high-availability setup was seamless. Their 24/7 monitoring gives us peace of mind knowing our data is always protected and accessible. Fantastic enterprise-grade service!",
        image:testimonial5
    },
